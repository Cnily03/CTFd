...
def load(app):
    ...
    register_plugin_assets_directory(
        ...
        endpoint="plugins.ctfd_whale.assets",
    )
    """
    register_admin_plugin_menu_bar(
        title='Whale',
        route='/plugins/ctfd_whale/admin/settings'
    )
    """
    ...
    DynamicValueDockerChallenge.scripts = {
        "create": "/plugins/ctfd_whale/assets/create.js",
        "update": "/plugins/ctfd_whale/assets/update.js",
        "view": "/plugins/ctfd_whale/assets/view.js",
    }
    CHALLENGE_CLASSES["dynamic_docker_whale"] = DynamicValueDockerChallenge
    ...
    page_blueprint = Blueprint(
        ...
        url_prefix="/plugins/ctfd_whale",
    )
    CTFd_API_v1.add_namespace(admin_namespace, path="/plugins/ctfd_whale/admin")
    CTFd_API_v1.add_namespace(user_namespace, path="/plugins/ctfd_whale")
